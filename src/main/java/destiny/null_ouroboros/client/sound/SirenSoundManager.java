...
public class SirenSoundManager {
    ...
    public static void play(BlockPos pos, SoundEvent normalEvent, SoundEvent distantEvent, boolean looping) {
        ...
        var normal = new SirenSoundInstance(normalEvent, SoundSource.WEATHER, pos, looping, 0f, 128f);
        var distant = new SirenSoundInstance(distantEvent, SoundSource.WEATHER, pos, looping, 64f, 256f);
        sm.play(normal);
        sm.play(distant);
